        ...
        <div className="lg:w-[960px] mx-auto p-6">
          ...
          <div className="flex justify-center lg:justify-between items-center flex-wrap md:mt-4">
            <div className="w-full md:w-1/3 p-4">
              <a
                href="mailto:legal@jetacapital.io?subject=Funding Inquiry - JETA CAPITAL"
            ...
            <div className="w-full md:w-1/3 p-4">
              <a
                href="mailto:legal@jetacapital.io?subject=General Inquiry - JETA CAPITAL"
                className="w-56 bg-white font-bold py-4 text-center rounded-xl block mx-auto"
              >
                General Inquiry
              </a>
            ...
            <div className="w-full md:w-1/3 p-4">
              <a
                href="mailto:legal@jetacapital.io?subject=Press Inquiry - JETA CAPITAL"
                className="w-56 bg-white font-bold py-4 text-center rounded-xl block mx-auto"
              >
                Press Inquiry
              </a>
